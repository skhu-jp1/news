package se.sowl.jigeumapi.oauth.factory;
...
import se.sowl.jigeumdomain.oauth.domain.OAuth2Profile;
import se.sowl.jigeumdomain.oauth.domain.OAuth2UserAttribute;
import se.sowl.jigeumdomain.oauth.domain.Role;
import se.sowl.jigeumdomain.user.domain.CustomOAuth2User;
